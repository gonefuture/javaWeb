		...
		<div class=" nav navbar-default navbar-fixed-top" style="background-color: RGB(255,255,240);">
			...
			<div class="collapse navbar-collapse" id="menu">
				<ul class="nav nav-pills navbar-left ">
					...
					<li>
						<a href="user/home.jsp"><img src="img/ico/home.ico">首&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;页</a>
					</li>				
					<li>
						<a href="user/changePwd.jsp"><img src="img/ico/lock.ico">修改密码</a>
					</li>
					<li>
						<a href="user/history.html"><img src="img/ico/history.ico">服务记录</a>
					</li>
				</ul>
			</div>
		</div <br /><br /><br /><br />>
