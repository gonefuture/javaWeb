...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<c:url value='/admin/css/login.css'/>">
	<script type="text/javascript" src="<c:url value='/admin/js/jquery-1.7.2.js'/>"></script>
	<script type="text/javascript" src="<c:url value='/admin/js/login.js'/>"></script>
        ...
        <div class="login1">
	      <div class="login2">
            <div class="loginTopDiv">
              <span class="loginTop">仲恺小助手</span>
            </div>
            <div>
              <form target="_top" action="<c:url value='/ManagerServlet'/>" method="post" id="loginForm">
                <input type="hidden" name="method" value="login" />
                  <table>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td align="left">
                        <input type="image" id="submit" src="<c:url value='/admin/image/login1.jpg'/>" class="loginBtn"/>
                      </td>
                    </tr>																				
                 </table>
              </form>
