			...
			<div class="row">
				...
				<div class="col-md-2" >
					<ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="220" >
						...
						<li  class="active"><a href="#3">已维修报单</a></li>
				...
				<div class="col-md-10  main-right divMain" align="center">
					<div class="divTitle">
						...
						<span style="margin-left: 28px;margin-right: 50px;">接单员</span>
					</div>
					<br/>
...
<%-- 					<c:forEach items="${pager.beanList }" var="order"> --%>
						<tr class="tt">
							...
							<td width="200px"colspan="3">时间：2013-06-01 19:30:22~~2013-06-01 19:30:22</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
